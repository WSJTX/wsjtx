...
case "$ARCH" in
  ...
  # SHA256 captured at S138 against linuxdeploy 1-alpha-20251107-1.
  # linuxdeploy DOES publish armhf at this tag (verified via GitHub
  # releases API); the qt plugin's `continuous` channel also publishes
  # armhf.
  armhf)   LINUXDEPLOY_SHA256="e359161979fa4bee50b92ce7102fb510299caebf34f711d983fba7a8f4bb1c2e" ;;
