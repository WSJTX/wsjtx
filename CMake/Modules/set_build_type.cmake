...
macro (set_build_type)
  ...
  if (_WSJT_RELEASE_CHANNEL STREQUAL "DEVEL")
    if (NOT WSJT_RC_NUMBER STREQUAL "")
      message (FATAL_ERROR "WSJT_RC_NUMBER must be empty when WSJT_RELEASE_CHANNEL is DEVEL.")
    endif ()
  ...
  elseif (NOT WSJT_RC_NUMBER STREQUAL "")
    message (FATAL_ERROR "WSJT_RC_NUMBER must be empty when WSJT_RELEASE_CHANNEL is GA.")
  endif ()
