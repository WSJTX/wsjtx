program test_packjt77_invariants
  ...
  call expect_round_trip_with_hashes('<W3CCX> <K1JT/P> 594095 AA00AA', &
       '<W3CCX> <K1JT/P> 592047 AA00AA', 5, 0, 0, 'W3CCX', 'K1JT/P', '')
  call expect_round_trip_with_hashes('<W3CCX> <K1JT/P> 594095 RR99XX', &
  ...
  call expect_not_message_type('<W3CCX> <K1JT/P> 594096 FN20QI', 5, 0)
