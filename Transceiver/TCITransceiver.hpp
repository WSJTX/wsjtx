...
private:
  ...
  qint32 m_ns;
  // m_samplesPerFFT must not exceed this post-downsampling limit; m_buffer
  // scales it to hold one complete block at the input sample rate.
