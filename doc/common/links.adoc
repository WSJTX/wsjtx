...
:devrepo: https://github.com/WSJTX/wsjtx/[GitHub]
:dimension4: http://www.thinkman.com/dimension4/[Thinking Man Software]
:downloads: https://wsjtx.github.io/wsjtx/downloads.html[WSJT Downloads Page]
...
:homepage: https://wsjtx.github.io/wsjtx/index.html[WSJT Home Page]
...
:wsjtx_group: https://wsjtx.groups.io/g/main[WSJTX Group]
:wsjt_group:  https://groups.io/g/wsjtgroup[WSJT Group]
...
:osxarm: https://sourceforge.net/projects/wsjt/files/wsjtx-{VERSION}/wsjtx-{VERSION}-Arm-Darwin.dmg[wsjtx-{VERSION}-ARM-Darwin.dmg]
...
:wsjt-devel: https://sourceforge.net/projects/wsjt/lists/wsjt-devel/[wsjt-devel]
// MAIL-TO links
