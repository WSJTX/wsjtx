...
*JT65*, *Q65*, *MSK144*, *JTTY*, *WSPR*, *FST4W*, and *Echo*.  The first eight
...
lengths as short as the fast modes.  "`Slow`" in this sense implies
...
*JTTY* is designed for fast radio contest exchanges and other
keyboard-to-keyboard communication. Its operational feel is similar to
standard RTTY, but it has much better weak-signal performance and far
lower error rate. JTTY transmissions are not timed or synchronized
with UTC; they can start at any time and have any duration, but
