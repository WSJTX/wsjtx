_WSJT-X_ offers twelve
different protocols or modes: *FST4*, *FT4*, *FT8*, *JT4*, *JT9*,
*JT65*, *Q65*, *MSK144*, *WSPR*, *FST4W*, *PI4*, and *Echo*.  The first eight
...
*PI4* is a receive-only decoder for the 4-FSK propagation beacons
transmitted by the IARU Region 1 VHF Committee's "Next Generation
Beacon" network. A PI4 transmission carries up to eight characters —
ordinarily a beacon's callsign — using a rate-1/2 K=32 convolutional
code, the same family WSPR and JT9 use. Four channel-spacing variants
(PI4, PI4-80, PI4-96, and PI4-120) are searched for automatically;
there is no PI4 transmitter in _WSJT-X_, and because a PI4 message
carries no grid locator, decodes are not placed on a map.
