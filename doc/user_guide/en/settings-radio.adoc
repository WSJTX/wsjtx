...
commands. Transmission resumes when all holds clear, provided the
transmit sequence is still active.
...
stops accepting commands; existing holds remain until they expire.
