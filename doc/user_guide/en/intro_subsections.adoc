...
source-code repository can be found at {devrepo}, and you can submit
explicit pull requests there. We especially encourage those with
translation skills to volunteer their help, either for this _User
Guide_ or for the program's user interface.

Bug reports and suggestions for new features or improvements to the
_WSJT-X User Guide_ may be submitted at the {devrepo} site or sent to
one of the email lists listed in the <<SUPPORT,Support>> section. You
must join the group in order to post messages to the email list.

=== License

*WSJT* is an open-source project hosted at https://... [GitHub]
