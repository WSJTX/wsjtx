...
*WSJT* is an open-source project hosted at {devrepo}. If you have
...
development team. You can submit bug reports, suggestions for new
features, and explicit pull requests at the {devrepo} site. We
especially encourage those with translation skills to volunteer their
help, either for this _User Guide_ or for the program's user
interface.

=== License

_WSJT-X_, _MAP65_, and _QMAP_ are free software intended for
communication by Amateur Radio. Copyright (C) 2001-2026 by Joseph
Taylor, K1JT, and the WSJT Development Team.

You can redistribute and/or modify these programs under the terms of
Version 3 of the GNU General Public License as published by the Free
Software Foundation.  The programs are distributed in the hope that
they will be useful, but WITHOUT ANY WARRANTY; without even the
implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR
PURPOSE. See the https://www.gnu.org/licenses/gpl-3.0.txt[GNU General
