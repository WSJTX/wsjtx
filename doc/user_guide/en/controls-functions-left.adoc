...
When operating as a Hound, double-click a potential Fox decoded at
`:00` or `:30`. Stations decoded at `:15` or `:45` use the Hound
transmit slot and cannot be selected.
