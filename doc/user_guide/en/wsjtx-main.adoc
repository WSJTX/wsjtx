...
= _WSJT-X_ User Guide
Copyright 2001-2026 by the WSJT Development Team.
:revnumber: {VERSION}
...
[.copyright]
_You may use and distribute unmodified copies of this document,
including this copyright notice. You may not publish or distribute
any portion of it without our express written consent._
...
Installation packages for Windows, Linux, and macOS are found on the
{downloads}.
...
[[SRC_CODE]]
include::install-from-source.adoc[leveloffset=+2]
...
[[JTTY_N1MM]]
=== JTTY and N1MM Logger+
include::jtty_n1mm_integration.adoc[]
