...
* In some circumstances it may be desirable to make your QSOs as short
  ...
  *Next* column or *Tx 1* button in the *Now* column.  Similarly, in
  modes that support RR73, double-click one of the *Tx 4* buttons to
  send RR73 rather than RRR.  Legacy 72-bit and shorthand modes always
  use RRR for Tx4.
