...
As an untimed mode, in the present context JTTY is neither a "`Fast`"
nor a "`Slow`" mode. Somewhat arbitrarily, then, we summarize
parameters of its protocol here. (... more to be added ...)
...
|JTTY     |K=10, r=1/2|(92,46) | 4|4-GFSK| 31.25|  125  | 0.22| 1.888
|===
